...
@endif
                        <div>
                            ...
                            <input type="text" name="name" id="name" placeholder="Your name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                        </div>
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Already have an account? <a href="/login" class="font-medium text-primary-600 hover:underline dark:text-blue-700">Login here</a>
                        </p>
                    </form>
                </div>
            </div>
    ...
    document.querySelector('form').addEventListener('submit', function (e) {
        // Example: Simple front-end validation
        ...
        if (!['2', '3'].includes(role)) errors.push('Invalid role selected');
